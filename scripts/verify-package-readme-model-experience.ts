...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/util/random-uuid': { kind: 'none', reason: 'Pure identifier generator; consumers use its values only for model-hidden correlation and browser-local state.' },
